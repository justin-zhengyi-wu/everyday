...
function updateAmout(amount, exchange) {
...
chrome.omnibox.setDefaultSuggestion({
    'description': 'Find current USD price'
});

chrome.omnibox.onInputChanged.addListener(updateAmout);
